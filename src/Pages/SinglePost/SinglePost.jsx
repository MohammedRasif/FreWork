...
function SinglePost() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 flex flex-col items-center justify-center relative">
      ...
      <button
        onClick={() => navigate(-1)}
        className="mb-4 px-4 py-2 bg-gray-200 text-gray-800 rounded-md hover:bg-gray-300 transition-colors absolute top-4 left-4"
      >
        Back
      </button>

      <div className="rounded-lg bg-white shadow-sm border border-gray-200 max-w-2xl w-full">
