            ...
            >
              ...
              <div className="flex-1 p-4 sm:p-4">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-3 sm:mb-3">
                  ...
                  <button className="flex items-center space-x-2 bg-[#3776E2] text-white px-3 sm:px-4 py-2 rounded-full hover:bg-blue-600 transition-colors cursor-pointer  sm:w-auto">
