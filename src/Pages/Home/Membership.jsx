...
const Membership = () => {
  ...
  return (
    <div className="flex flex-col sm:flex-row bg-gray-50 px-4 sm:px-10 pb-16 roboto">
      ...
      <div className="w-full sm:w-4/5 p-4 sm:p-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-500 text-sm sm:text-md font-bold sm:font-medium">
        ...
        <div className="relative mb-6 sm:mb-8 w-full sm:w-96">
          <div className="flex">
            ...
            />
            <button className="px-4 sm:px-5 py-2 sm:py-3 bg-[#3776E2] text-white rounded-r-lg transition-colors">
          ...
          {tourPlans.map((plan) => (
            ...
            >
              ...
              <div className="w-full sm:w-72 h-48 sm:h-56 relative">
                ...
                {plan.verified && (
                  <div>
                    <div className="absolute top-3 right-2 backdrop-brightness-75 text-white px-2 py-1 text-sm sm:text-md font-bold sm:font-medium flex items-center space-x-2 rounded-full">
                      <h1>Verified</h1>
                      <VscVerifiedFilled size={20} sm:size={24} className="text-green-500" />
                    </div>
                    <div className="bg-gray-300 rounded-full absolute bottom-3 right-2 p-1">
                      <FaHeart className="text-gray-600 pt-[1px]" size={18} sm:size={22} />
                    </div>
                  </div>
                )}
              </div>
              ...
              <div className="flex-1 p-4 sm:p-4">
                {/* Agency Header */}
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-3 sm:mb-3">
                  <div className="flex items-center space-x-3 mb-3 sm:mb-0">
                    ...
                    <div>
                      <h3 className="font-bold sm:font-semibold text-lg sm:text-xl text-gray-800">
                        {plan.agency}
                      </h3>
                      <div className="flex items-center space-x-1">
                        <Star className="w-4 h-4 sm:w-4 sm:h-4 fill-yellow-400 text-yellow-400" />
                        <span className="text-sm sm:text-sm text-gray-600 font-bold sm:font-medium">
                          {plan.rating}
                        </span>
                        <span className="text-sm sm:text-sm text-gray-500 font-bold sm:font-medium">
                          ({plan.reviews} Reviews)
                        </span>
                      </div>
                    </div>
                  </div>
                  <button className="flex items-center space-x-2 bg-[#3776E2] text-white px-3 sm:px-4 py-2 rounded-full hover:bg-blue-600 transition-colors cursor-pointer w-full sm:w-auto">
                    <MessageCircle className="w-4 h-4 sm:w-5 sm:h-5" />
                    <span className="text-sm sm:text-md font-bold sm:font-medium">Message</span>
                  </button>
                </div>

                {/* About Section */}
                <div className="mb-3 sm:mb-4">
                  <h4 className="font-bold sm:font-semibold text-gray-800 mb-2 text-base sm:text-base">
                    About
                  </h4>
                  <p className="text-gray-600 font-bold sm:font-medium text-sm sm:text-sm leading-relaxed line-clamp-3">
                    {plan.about}
                  </p>
                </div>
                ...
                {/* Location and Price */}
                <div>
                  <p className="text-gray-700 font-bold sm:font-medium text-sm sm:text-md">
          ...
          {topAgencies.map((agency, index) => (
            <div key={index} className="flex items-center space-x-3">
              ...
              <div className="flex-1 min-w-0">
                <h4 className="font-bold sm:font-medium text-gray-800 text-sm sm:text-md truncate">
                  {agency.name}
                </h4>
                <div className="flex items-center space-x-1">
                  <Star className="w-3 h-3 sm:w-3 sm:h-3 fill-yellow-400 text-yellow-400" />
                  <span className="text-xs sm:text-xs text-gray-600 font-bold sm:font-medium">
                    {agency.rating}
                  </span>
                  <span className="text-xs sm:text-xs text-blue-500 underline font-bold sm:font-medium">
