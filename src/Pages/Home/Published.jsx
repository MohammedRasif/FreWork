...
const Published = () => {
    ...
    return (
        <div
            className="pb-8 px-4 bg-gradient-to-b from-white to-[#4691F2]/10"
        >
            <div className="text-center py-16">
                <p className="text-gray-700 text-lg mb-4 font-medium">Top Requests are here </p>
                <h1 className="text-4xl md:text-5xl font-semibold text-[#3F4C65]">Last Request Published</h1>
            </div>
                        ...
                        >
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex items-center mb-4">
                                    <svg className="w-5 h-5 text-[#849ECC] mr-2" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" />
                                    </svg>
                                    <span className="text-gray-700 text-sm font-medium">{item.location}</span>
                                </div>
